...
mail.moderation|status|Status|Selection| ('allow', 'Always Allow'),
        ('ban', 'Permanent Ban')]
...
mail.channel|channel_type||Selection|
...
mail.channel|channel_partner_ids|Listeners|Many2many|'res.partner', 'mail_channel_partner', 'channel_id', 'partner_id'
...
mail.channel|public||Selection|('public', 'Everyone'),
...
mail.message|attachment_ids|Attachments|Many2many|'ir.attachment', 'message_attachment_rel',
        'message_id', 'attachment_id',
mail.message|parent_id||Many2one|index=True, ondelete='set null'
mail.message|child_ids||One2many|'mail.message', 'parent_id', 'Child Messages'
...
mail.message|message_type||Selection|[
        ('email', 'Email'),
        ('comment', 'Comment'),
...
mail.activity.type|delay_unit|Delay units|Selection|[
        ('days', 'days'),
        ('weeks', 'weeks'),
        ('months', 'months')]
mail.activity.type|delay_from|Delay Type|Selection|[
        ('current_date', 'after validation date'),
        ('previous_activity', 'after previous activity deadline')]
mail.activity.type|icon||Char|Icon
mail.activity.type|decoration_type|Decoration Type|Selection|[
        ('warning', 'Alert'),
        ('danger', 'Error')]
